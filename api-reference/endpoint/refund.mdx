...
api: "POST https://carteira.nevermissapps.com/v1/refund"
...
```bash cURL
curl -X POST https://carteira.nevermissapps.com/v1/refund \
...
```javascript Node.js
const response = await fetch('https://carteira.nevermissapps.com/v1/refund', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://carteira.nevermissapps.com/v1/refund',
    headers={
        'Authorization': 'Bearer SUA_API_KEY',
        'Content-Type': 'application/json'
    },
...
```php PHP
<?php
$ch = curl_init('https://carteira.nevermissapps.com/v1/refund');
